...
def create_certificate(
    name, template_path, font_path, font_size, position, output_path
):
    ...
    # Load the font
    font = ImageFont.truetype("Certificate/times.ttf", 40)
...
font_path = "Certificate/times.ttf"  # Example font path
font_size = 40
